 ...
 * last solution, to fill up a row we only need previous row's values
 * 
 * initialize 2 arrays capacity + 1
 * dp : array represents the subproblem up to previous, for i - 1 th item
 * temp : array represents the subproblem up to the current, that is ith item
 * 
 * nested loop fills temp in the inner loop and after solving for the item
 * set temp to dp 
 * 
 * 
 */
public class knapsackIV {
